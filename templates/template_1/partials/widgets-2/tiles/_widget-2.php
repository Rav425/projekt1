										...
										<div class="card h-175px bgi-no-repeat bgi-size-contain h-200px mb-5 mb-lg-10" style="background-color: #1B283F; background-position: right; background-image:url('<?php echo CPTMPL; ?>assets/media/svg/misc/taieri.svg')">
											<!--begin::Body-->
