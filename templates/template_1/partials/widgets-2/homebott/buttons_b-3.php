	...
	<div class="card-body" style="text-align:center">
		<div class="row g-5 g-lg-10">
			<div class="col-xl-5  mb-xl-5">
				<!--begin::Svg Icon | path: /var/www/preview.keenthemes.com/kt-products/docs/metronic/html/releases/2023-01-26-051612/core/html/src/media/icons/duotune/technology/teh002.svg-->
				<span class="svg-icon svg-icon-white svg-icon-5x ms-n1"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
			...
			<div class="col-xl-5  mb-xl-5">
				<div class="text-white fw-bold fs-2 mb-2 mt-5" data-kt-countup="true" data-kt-countup-value="<?php echo $init_videos->show_reportTotalCount(); ?>">0</div>
			</div>
		</div>
		<div class="row g-5 g-lg-5">
			<div class="fw-bold text-white fs-1 mb-2 mt-5 2tx: text-lg">بـــــــــلاغ</div>
		</div>
