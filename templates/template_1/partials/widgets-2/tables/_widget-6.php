						...
						<tbody>
								...
								<td>
									<div class="symbol symbol-50px me-2">
										<span class="symbol-label">
											<img src="<?php echo CPTMPL; ?>assets/media/svg/avatars/001-boy.svg" class="h-75 align-self-end" alt="" />
										</span>
									</div>
								</td>
								<td>
							...
							<tr>
								<td>
									<div class="symbol symbol-50px me-2">
										<span class="symbol-label">
											<img src="<?php echo CPTMPL; ?>assets/media/svg/avatars/018-girl-9.svg" class="h-75 align-self-end" alt="" />
										</span>
									</div>
								</td>
								<td>
							...
							<tr>
								<td>
									<div class="symbol symbol-50px me-2">
										<span class="symbol-label">
											<img src="<?php echo CPTMPL; ?>assets/media/svg/avatars/047-girl-25.svg" class="h-75 align-self-end" alt="" />
										</span>
									</div>
								</td>
								<td>
							...
							<tr>
								<td>
									<div class="symbol symbol-50px me-2">
										<span class="symbol-label">
											<img src="<?php echo CPTMPL; ?>assets/media/svg/avatars/014-girl-7.svg" class="h-75 align-self-end" alt="" />
										</span>
									</div>
								</td>
								<td>
							...
							<tr>
								<td>
									<div class="symbol symbol-50px me-2">
										<span class="symbol-label">
											<img src="<?php echo CPTMPL; ?>assets/media/svg/avatars/043-boy-18.svg" class="h-75 align-self-end" alt="" />
										</span>
									</div>
								</td>
								<td>
