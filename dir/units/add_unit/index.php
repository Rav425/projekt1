<div class="toolbar mb-5 mb-lg-7" id="kt_toolbar">
	<div class="page-title d-flex flex-column me-3">
		<h1 class="d-flex text-dark fw-bolder my-1 fs-3"><?=$init_lang->pick_lang('ADD_NEW_UNIT')?></h1>
		<ul class="breadcrumb breadcrumb-dot fw-bold text-gray-600 fs-7 my-1">
			<li class="breadcrumb-item text-gray-600">
				<a href="?go=home" class="text-gray-600 text-hover-primary"><?=$init_lang->pick_lang('HOME_TITLE')?></a>
			</li>
			<li class="breadcrumb-item text-gray-600"><?=$init_lang->pick_lang('ADD_NEW_UNIT')?></li>
		</ul>
	</div>
</div>
    ...
    <div class="card mb-20 mb-xl-10">
        <div class="card-header cursor-pointer">
            <div class="card-title m-0">
                <h3 class="fw-bolder m-0"><?php $init_lang->pick_lang('ADD_NEW_UNIT'); ?></h3>
            </div>
        </div>
            ...
            <form id="unit_form" class="form">
                <div class="card-body p-9">
                    ...
                    <div class="row mb-10 fv-row">
                        ...
                        <div class="dropzone col-lg-5 fv-row" id="upload_images">
                    ...
                    <div class="row g-9 mb-10">
                        ...
                        <div class="col-md-3 fv-row">
                            <label class="fs-4 fw-bolder mb-2"><?=$init_lang->pick_lang('SELECT_CAT')?></label>
                            <select name="u_cat" id="u_cat" data-hide-search="true" aria-label="<?=$init_lang->pick_lang('SELECT_CAT')?>" 
                                data-control="select2" data-placeholder="<?php $init_lang->pick_lang('SELECT_CAT'); ?>" class="form-select form-select-solid form-select-lg fs-4">
                                <option value=""><?=$init_lang->pick_lang('SELECT_CAT')?></option>
                                <option value="0">No Category</option>
                                <?=$init_categories->select_category()?>
                            </select>
                        </div>
                ...
                <div class="card-footer d-flex justify-content-end py-6">
                    ...
                    <button type="button" class="btn btn-primary me-2 px-20" id="submit_unit">
