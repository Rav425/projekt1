...
<a href="#" class="card bg-light hoverable card-xl-stretch mb-5 mb-xl-8">
	...
	<div class="card-body" dir="rtl" style="text-align:center">
		<!--begin::Svg Icon | path: /var/www/preview.keenthemes.com/kt-products/docs/metronic/html/releases/2023-01-26-051612/core/html/src/media/icons/duotune/social/soc001.svg-->
		...
		<!--end::Svg Icon-->
		<div class="text-white fw-bold fs-2 mb-2 mt-5" data-kt-countup="true" data-kt-countup-value="00000">0</div>
		<div class="fw-semibold text-white fw-bold fs-1 mb-1 mt-5">IOS</div>
