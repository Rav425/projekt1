...
<a href="#" class="card bg-primary hoverable card-xl-stretch mb-xl-8">
	...
	<div class="card-body" dir="rtl">
		...
		<!--end::Svg Icon-->
		<div class="text-white fw-bold fs-2 mb-2 mt-5" data-kt-countup="true" data-kt-countup-value="<?php echo $init_videos->show_commentsTotalCount(); ?>" id="comments_count"></div>
		<div class="fw-semibold text-white fw-bold fs-1 mb-1 mt-5">تعليق</div>
	</div>
	<!--end::Body-->
</a>
