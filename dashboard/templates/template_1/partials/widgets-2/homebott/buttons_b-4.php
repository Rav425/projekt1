...
<a href="#" class="card bg-warning hoverable card-xl-stretch mb-5 mb-xl-8">
	...
	<div class="card-body" style="text-align:center">
		<div class="row g-5 g-lg-10">
			...
			<div class="col-xl-5  mb-xl-5">
				<div class="text-white fw-bold fs-2 mb-2 mt-5" data-kt-countup="true" data-kt-countup-value="<?php echo $init_hashtags->show_hashTotalCount(); ?>">0</div>
			</div>
		</div>
		<div class="row g-5 g-lg-5">
			<div class="fw-bold text-white fs-1 mb-2 mt-5 2tx: text-lg">هاش تاج</div>
