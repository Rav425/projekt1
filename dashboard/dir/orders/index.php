<div class="content flex-row-fluid cairo" id="kt_content">
    ...
    <div class="toolbar mb-5 mb-lg-7" id="kt_toolbar">
        <div class="page-title d-flex flex-column me-3">
            <h1 class="d-flex text-dark fw-bolder my-1 fs-3">Manage Orders</h1>
            <ul class="breadcrumb breadcrumb-dot fw-bold text-gray-600 fs-7 my-1">
                <li class="breadcrumb-item text-gray-600">
                    <a href="?go=home" class="text-gray-600 text-hover-primary">Home</a>
                </li>
                <li class="breadcrumb-item text-gray-600">Orders</li>
            </ul>
        </div>
    ...
    <div class="card">
        <div class="card-header border-0 pt-6">
            <div class="card-title">
                ...
                <h3 class="card-label fw-bolder">All Requested Orders</h3>
            </div>
        </div>
        
        <div class="card-body pt-5">
            <table class="table align-center table-row-dashed fs-6 gy-5" id="orders_table">
                <thead>
                    <tr class="fw-bold text-gray-800 bg-light" style="text-align: center;">
                        ...
                        <th style="font-weight: bold;">Statue</th>
