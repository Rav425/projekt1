<div class="content flex-row-fluid cairo" id="kt_content">
    ...
    <div class="toolbar mb-5 mb-lg-7" id="kt_toolbar">
        <div class="page-title d-flex flex-column me-3">
            <h1 class="d-flex text-dark fw-bolder my-1 fs-3">Manage Language & Translation</h1>
            <ul class="breadcrumb breadcrumb-dot fw-bold text-gray-600 fs-7 my-1">
                <li class="breadcrumb-item text-gray-600">
                    <a href="?go=home" class="text-gray-600 text-hover-primary">Home</a>
                </li>
                <li class="breadcrumb-item text-gray-600">Language</li>
            </ul>
        </div>
        
        <div class="d-flex align-items-center py-2 py-md-1">
            <button type="button" id="reload_words" class="btn btn-light-success fw-bolder me-5">
            ...
            <button type="button" class="btn btn-light-primary fw-bolder" id="new_word">
                <span class="svg-icon svg-icon-5 svg-icon-gray-500 me-1">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
    ...
    <div class="card">
        <div class="card-header border-0 pt-6">
            <div class="card-title">
                ...
                <h3 class="card-label fw-bolder">All Recorded Language Words</h3>
            </div>
        </div>
        
        <div class="card-body pt-5">
            <table class="table align-center table-row-dashed fs-6 gy-5" id="words_table">
                <thead>
                    <tr class="fw-bold text-gray-800 bg-light" style="text-align: center;">
                        <th style="font-weight: bold;width:5%!important;">ID</th>
                        <th style="font-weight: bold;width:20%!important;">Key</th>
                        <th style="font-weight: bold;width:30%!important;">Englishlanguage</th>
                        <th style="font-weight: bold;width:30%!important;">Germanlanguage</th>
